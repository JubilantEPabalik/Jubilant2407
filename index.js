...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + 'FN:Affis Admin\n' 
            + 'ORG: Pengembang XBot;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=6281242420219:+62 812-4242-0219\n' 
            + 'END:VCARD' 
prefix = '#'
blocked = []   
limitawal = '99999999'
...
/******** OWNER NUMBER**********/
const ownerNumber = ["6281242420219@s.whatsapp.net","6281242420219@s.whatsapp.net"] 
/************************************/
		...
		try {
          ...
          if (!isRegistered) return reply(ind.noregis())
           ...
           case 'demote':
				...
				case 'listadmin':
					if (!isGroup) return reply(ind.groupo())
					teks = `𝗟𝗶𝘀𝘁 𝗮𝗱𝗺𝗶?? 𝗼𝗳 𝗴𝗿𝗼𝘂𝗽 *${groupMetadata.subject}*\n𝗧𝗼𝘁𝗮𝗹 : ${groupAdmins.length}\n\n`
					no = 0
